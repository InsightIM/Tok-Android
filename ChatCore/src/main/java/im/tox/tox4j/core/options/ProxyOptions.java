...
public class ProxyOptions {
    ...
    public ProxyOptions(ToxProxyType proxyType, String proxyAddress, int proxyPort) {
    ...
    public static ProxyOptions Http = new ProxyOptions(ToxProxyType.HTTP, null, 0);

    public static ProxyOptions Socks5 = new ProxyOptions(ToxProxyType.SOCKS5, null, 0);
}
