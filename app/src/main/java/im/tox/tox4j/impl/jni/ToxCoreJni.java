...
public final class ToxCoreJni {
    ...
    static native int toxFriendSendMessageOffline(int instanceNumber, int friendNumber, int cmd,
        int timeDelta, byte[] message) throws ToxFriendSendMessageException;
    ...
    static native byte[] toxEncryptMessageOffline(int instanceNumber, int friendNumber,byte[] bytes);

    static native byte[] toxDecryptMessageOffline(int instanceNumber, int friendNumber,byte[] bytes);

    static native long toxLocalMsgId (int instanceNumber, int friendNumber);
}
