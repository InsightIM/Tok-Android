...
import im.tox.tox4j.core.exceptions.GroupByPublicKeyException;
import im.tox.tox4j.core.exceptions.GroupCreateException;
import im.tox.tox4j.core.exceptions.GroupGetPublicKeyException;
import im.tox.tox4j.core.exceptions.GroupInvitePeerException;
import im.tox.tox4j.core.exceptions.GroupSendMessageException;
...
public final class ToxCoreJni {
    ...
    static native int toxFriendSendOfflineMessage(int instanceNumber, int receiverFriendNumber,
        int proxyFriendNumber, byte[] message) throws ToxFriendSendMessageException;
    ...
    static native int groupCreate(int instanceNumber, byte[] groupName) throws GroupCreateException;

    static native int groupGetNumber(int instanceNumber, byte[] publicKey)
        throws GroupByPublicKeyException;

    static native byte[] groupGetPublicKey(int instanceNumber, int groupNumber)
        throws GroupGetPublicKeyException;

    static native int groupSendMessage(int instanceNumber, int groupNumber, int type, int timeDelta,
        byte[] message) throws GroupSendMessageException;

    static native void groupInvitePeer(int instanceNumber, int groupNumber, int friendNumber)
        throws GroupInvitePeerException;
}
