...
public class ContactsInfo implements Serializable {
    ...
    @Ignore
    public ContactsInfo(ContactsKey key, String name, String alias, String signature,
        int contactType) {
        this.key = key;
        this.online = false;
        if (name != null) {
    ...
    @Ignore
    public ContactsInfo(ContactsKey key, boolean online, ToxNickname name, ToxNickname alias,
