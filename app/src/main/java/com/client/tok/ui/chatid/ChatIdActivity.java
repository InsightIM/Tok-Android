...
public class ChatIdActivity extends BaseCommonTitleActivity
    implements ChatIdContract.IChatIdView, View.OnClickListener {
    private View mCopyTv;
    private TextView mTokIdTv;
    private ImageView mTokIdIv;

    private ChatIdContract.IChatIdPresenter mChatIdPresenter;
    ...
    @Override
    public void setPresenter(ChatIdContract.IChatIdPresenter chatIdPresenter) {
