...
public class MyInforActivity extends BaseCommonTitleActivity
    ...
    private String mSelfKey = CoreManager.getManager().toxBase.getSelfKey().getKey();
        ...
        switch (id) {
            case R.id.id_my_info_portrait_iiv://TODO
                DialogFactory.showSelImgMethodDialog(this,
                    StringUtils.getTextFromResId(R.string.edit_avatar), (View cancel) -> {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == FilePicker.REQ_IMG_GALLERY
                ...
                if (fileUri != null) {
                    String inPath = ImageUtils.getImgPathFromUri(this, fileUri);
                ...
                String sourcePath = data.getStringExtra(IntentConstants.IMG_OUT_PATH);
