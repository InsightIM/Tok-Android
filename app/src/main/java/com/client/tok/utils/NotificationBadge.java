...
public class NotificationBadge {
    ...
    public static class DefaultBadger implements Badger {
        ...
        @Override
        public List<String> getSupportLaunchers() {
            return Arrays.asList("fr.neamar.kiss", "com.quaap.launchtime",
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString("package", TokApplication.getInstance().getPackageName());
    ...
    public static class NewHtcHomeBadger implements Badger {
        ...
        public static final String INTENT_UPDATE_SHORTCUT =
            "com.htc.launcher.action.UPDATE_SHORTCUT";
        public static final String INTENT_SET_NOTIFICATION =
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            TokApplication.getInstance()
                .getContentResolver()
                .insert(Uri.parse(CONTENT_URI), contentValues);
        }
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            try {
                ...
                TokApplication.getInstance()
                    .getContentResolver()
                    .call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, extras);
    ...
    public static class SamsungHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            ContentResolver contentResolver = TokApplication.getInstance().getContentResolver();
            Cursor cursor = null;
            try {
                cursor = contentResolver.query(mUri, CONTENT_PROJECTION, "package=?",
                    new String[] { componentName.getPackageName() }, null);
                if (cursor != null) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        ContentValues contentValues =
                            getContentValues(componentName, badgeCount, false);
                        contentResolver.update(mUri, contentValues, "_id=?",
                            new String[] { String.valueOf(id) });
                        if (entryActivityName.equals(
                    ...
                    if (!entryActivityExist) {
                        ContentValues contentValues =
                            getContentValues(componentName, badgeCount, true);
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private static final String INTENT_EXTRA_PACKAGE_NAME =
            "com.sonyericsson.home.intent.extra.badge.PACKAGE_NAME";
        private static final String INTENT_EXTRA_ACTIVITY_NAME =
            "com.sonyericsson.home.intent.extra.badge.ACTIVITY_NAME";
        private static final String INTENT_EXTRA_MESSAGE =
            "com.sonyericsson.home.intent.extra.badge.MESSAGE";
        private static final String INTENT_EXTRA_SHOW_MESSAGE =
            "com.sonyericsson.home.intent.extra.badge.SHOW_MESSAGE";

        private static final String PROVIDER_CONTENT_URI =
            "content://com.sonymobile.home.resourceprovider/badge";
        private static final String PROVIDER_COLUMNS_BADGE_COUNT = "badge_count";
        private static final String PROVIDER_COLUMNS_PACKAGE_NAME = "package_name";
        private static final String PROVIDER_COLUMNS_ACTIVITY_NAME = "activity_name";
        private static final String SONY_HOME_PROVIDER_NAME =
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(
                    TokApplication.getInstance().getApplicationContext().getContentResolver()) {
            ...
            insertBadgeAsync(badgeCount, componentName.getPackageName(),
        ...
        private static boolean sonyBadgeContentProviderExists() {
            ...
            ProviderInfo info = TokApplication.getInstance()
                .getPackageManager()
    ...
    public static class XiaomiHomeBadger implements Badger {
        ...
        public static final String EXTRA_UPDATE_APP_MSG_TEXT =
        ...
        public void executeBadge(int badgeCount) {
            try {
                ...
                sendBroadcast(localIntent, true);
            }
        }

        @Override
        public List<String> getSupportLaunchers() {
            return Arrays.asList("com.miui.miuilite", "com.miui.home", "com.miui.miuihome",
                "com.miui.miuihome2", "com.miui.mihome", "com.miui.mihome2");
        }
    }
            ...
            ThreadUtils.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        TokApplication.getInstance()
                            .getContentResolver()
                            .call(CONTENT_URI, "setAppBadgeCount", null, extra);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static class VivoHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            intent.putExtra("packageName", TokApplication.getInstance().getPackageName());
            intent.putExtra("className", componentName.getClassName());
    ...
    private static boolean initBadger() {
        ...
        if (resolveInfo != null) {
            ...
            for (Class<? extends Badger> b : BADGERS) {
                ...
                if (shortcutBadger != null && shortcutBadger.getSupportLaunchers()
                    .contains(currentHomePackage)) {
    ...
    private static void sendBroadcast(final Intent intent, boolean check) {
        if (!check || canResolveBroadcast(intent)) {
            ThreadUtils.runOnUIThread(new Runnable() {
                @Override
                public void run() {
                    TokApplication.getInstance().sendBroadcast(intent);
                }
            });
        }
    }
    ...
    private static boolean canResolveBroadcast(Intent intent) {
        PackageManager packageManager = TokApplication.getInstance().getPackageManager();
