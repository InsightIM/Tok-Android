...
public class GLDrawer2D {
    ...
    public static int loadShader(final String vss, final String fss) {
        ...
        if (compiled[0] == 0) {
            LogUtil.i(TAG, "Failed to compile vertex shader:" + GLES20.glGetShaderInfoLog(vs));
        ...
        if (compiled[0] == 0) {
            LogUtil.i(TAG, "Failed to compile fragment shader:" + GLES20.glGetShaderInfoLog(fs));
