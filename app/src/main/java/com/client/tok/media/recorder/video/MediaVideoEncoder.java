...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public boolean frameAvailableSoon(final float[] tex_matrix, final float[] mvp_matrix) {
        boolean result;
        if (result = super.frameAvailableSoon()) mRenderHandler.draw(tex_matrix, mvp_matrix);
        return result;
    }
    ...
    static final int selectColorFormat(final MediaCodecInfo codecInfo,
        ...
        LogUtil.i(TAG, "selectColorFormat: ");
        int result = 0;
    ...
    private static final boolean isRecognizedViewoFormat(final int colorFormat) {
        LogUtil.i(TAG, "isRecognizedViewoFormat:colorFormat=" + colorFormat);
    ...
    protected void signalEndOfInputStream() {
        LogUtil.i(TAG, "sending EOS to encoder");
